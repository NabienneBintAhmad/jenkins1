...
<form class="form-inline my-2 my-lg-0" action="" method="POST">
      <input name="suprod"   class="form-control mr-sm-2" type="texte" placeholder="supprimer" aria-label="texte" required>
     <button class="btn btn-outline-success my-2 my-sm-0" name="valider" type="submit">supprimer</button>
    </form>

<?php
    if(isset($_POST['valider'])) {
    $sup=fopen('produits.txt','r' );
    $suprim=$_POST['suprod'];
    $recup="";
    while (!feof($sup)) {
     $ligne=fgets($sup);
